...
Route::group([
    ...
    Route::get('reset', ['uses' => 'AdminController@getReset', 'as' => 'getReset']);
    Route::post('reset', ['uses' => 'AdminController@postReset', 'as' => 'postReset']);
    ...
    if (Request::is(config('mixtra.ADMIN_PATH'))) {
        ...
        if ($menus) {
            if ($menus->type == 'Statistic') {
                ...
                $module = CRUDBooster::first('mit_modules', ['path' => $menus->path]);
