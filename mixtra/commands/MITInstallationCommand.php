...
class MITInstallationCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'MIXTRA Installation Command';
    ...
    public function handle()
    {
        ...
        /* Removing the default user and password reset, it makes you ambigous when using MITBooster */
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $this->info('Publishing MITBooster needs file...');
            $this->call('vendor:publish', ['--provider' => 'mixtra\MixtraServiceProvider']);
            ...
            // $configLFMModified = str_replace("['web','auth']", "['web','\mixtra\middlewares\Backend']", $configLFM);
            ...
            // if (! class_exists('MITSeeder')) {
            //     require_once __DIR__.'/../database/seeds/MITSeeder.php';
            // }
            ...
            $this->info('Installing MITBooster Is Completed ! Thank You :)');
        } else {
...
#                                                                                                                       
			");
        $this->info('--------- :===: Thanks for choosing MITBooster :==: ---------------');
        $this->info('====================================================================');
    }
