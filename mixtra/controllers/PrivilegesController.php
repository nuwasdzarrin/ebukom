...
class PrivilegesController extends MITController
{
    public function init()
    {
        ...
        $this->alert[] = [
            'message' => "You can use the helper MITBooster::getMyPrivilegeId() to get current user login privilege id, or MITBooster::getMyPrivilegeName() to get current user login privilege name",
            'type' => 'info',
        ];
    }
