...
class LogsController extends MITController
{
	...
	public function init() {
        ...
        $this->col[] = ["label" => "User", "name" => "mit_users_id", "join" => config('mixtra.USER_TABLE').",name"];
        ...
        $this->form[] = [
            ...
            "name" => "mit_users_id",
            "type" => "select",
            "datatable" => config('mixtra.USER_TABLE').",name",
            "readonly" => true,
        ];
