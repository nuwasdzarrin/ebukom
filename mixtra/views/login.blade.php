        ...
        <div class="card-body">
	        ...
	        <form class="form-horizontal form-material text-center" id="loginform"  autocomplete='off' action="{{ route('postLogin') }}" method="post">
                ...
                <a href="javascript:void(0)" class="db">
                    <img src="{{ MITBooster::getSetting('logo_dark')?asset(MITBooster::getSetting('logo_dark')):asset('assets/images/logo-dark.png') }}" alt="Home" style="width: auto;height: 150px;" /><br/>
