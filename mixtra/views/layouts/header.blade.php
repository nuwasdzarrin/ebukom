    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header" style="text-align: center;">
            <a class="navbar-brand" href="{{url(config('mixtra.ADMIN_PATH'))}}" title="{{Session::get('appname')}}">
                <!-- Logo icon -->
                <span class="navbar-brand-logo" style="display: none;">
                    <!-- Light Logo icon -->
                    <img src="{{ MITBooster::getSetting('logo_light')?asset(MITBooster::getSetting('logo_light')):asset('assets/images/logo-light.png') }}" alt="homepage" class="light-logo" style="width: 50px; height: auto;" />
                </span>
                <!--End Logo icon -->
                <!-- Logo text -->
