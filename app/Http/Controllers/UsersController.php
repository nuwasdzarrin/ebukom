...
class UsersController extends \mixtra\controllers\MITController {
	...
	public function init() {
		...
		$this->form[] = array("label"=>"Privilege","name"=>"mit_privileges_id","type"=>"select","datatable"=>"mit_privileges,name", 'datatable_where'=>'id != 4','required'=>true);						
    ...
    */
    ...
    {
        $query->whereIn('mit_users.mit_privileges_id', [1,2,3])->get();
    }
}
