...
class TeacherController extends \mixtra\controllers\MITController
{
   	public function init() {
        ...
        $this->col[] = array("label"=>"Teacher Info","name"=>"user_info");
        ...
        $this->form[] = array("label"=>"NIK","name"=>"nik",'required'=>true,'type'=>'text', 'validation' => 'required|unique:mit_users,nik');    
        ...
        $this->form[] = array("label"=>"Teacher Info","name"=>"user_info",'required'=>true,'type'=>'textarea');
    ...
    */
    ...
    {
        $query->where('mit_users.mit_privileges_id', '2')->get();
    }
